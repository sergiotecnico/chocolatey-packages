...
$packageName = 'axel' # arbitrary name for the package, used in messages
#$installerType = 'EXE_MSI_OR_MSU' #only one of these: exe, msi, msu
$url = 'https://github.com/ghuntley/cygwin-axel/raw/master/release/axel-2.4.zip' # download url
