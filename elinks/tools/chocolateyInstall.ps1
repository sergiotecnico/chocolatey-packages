...
$packageName = 'elinks' # arbitrary name for the package, used in messages
#$installerType = 'EXE_MSI_OR_MSU' #only one of these: exe, msi, msu
$url = 'https://github.com/ghuntley/chocolatey-binaries/raw/master/elinks-0.12pre3.zip' # download url
